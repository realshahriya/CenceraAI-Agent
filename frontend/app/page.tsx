    ...
    <>
      ...
      <main className="container" style={{ opacity: bootLoading ? 0 : 1, transition: 'opacity 0.6s ease 0.1s' }}>
        ...
        <div className="grid">
          ...
          {/* --- KNOWLEDGE BASE VIEW --- */}
          {activeTab === 'knowledge' && (
            <section className="panel mock-panel gradient-purple grid-span-all">
              <div className="panel-label">KNOWLEDGE BASE INDEX</div>
              <div className="mock-content">
                <div className="mock-icon purple">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                </div>
                <h3>COGNITIVE ARCHIVE OFFLINE</h3>
                <p>Vector database connection not established. Neural weights must be synced before accessing archived models and external API documentation.</p>
                <div className="mock-loader">
                  <div className="pulse-dot"></div>
                  <span>WAITING FOR VECTOR SYNC...</span>
                </div>
              </div>
            </section>
          )}
          ...
          {/* --- PROTOCOLS VIEW --- */}
          {activeTab === 'protocols' && (
            <section className="panel mock-panel gradient-pink grid-span-all">
              <div className="panel-label">EXECUTABLE PROTOCOLS</div>
              <div className="mock-content">
                <div className="mock-icon pink">
                ...
                <p>Configure automated on-chain behaviors, swap parameters, and decentralized agency rules for CENCERA.PRIME.</p>
                <div className="mock-list">
                  <div className="mock-list-item locked"><span>DEX ARBITRAGE</span> <span className="status">LOCKED</span></div>
                  <div className="mock-list-item locked"><span>LIQUIDITY YIELD</span> <span className="status">LOCKED</span></div>
                  <div className="mock-list-item locked"><span>PORTFOLIO REBALANCER</span> <span className="status">LOCKED</span></div>
                </div>
              </div>
            </section>
          )}
          ...
          {/* --- SWARM NETWORK VIEW --- */}
          {activeTab === 'network' && (
            <section className="panel mock-panel gradient-green grid-span-all">
              <div className="panel-label">SWARM NETWORK TOPOLOGY</div>
              <div className="mock-content node-map">
                <div className="mock-icon green">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg>
                </div>
                <h3>P2P NODE DISCONNECTED</h3>
                <p>Establishing secure connection to decentralized AI swarm nodes on the Fetch.ai Network.</p>
          ...
          {/* --- SYSTEM CONFIG VIEW --- */}
          {activeTab === 'settings' && (
            <section className="panel mock-panel gradient-gold grid-span-all">
              <div className="panel-label">SYSTEM CONFIGURATION</div>
              <div className="mock-content">
                ...
                <div className="mock-list">
                  <div className="mock-list-item">
                    <span>LLM INFERENCE ENGINE</span> 
                    <span className="status">ASI-1</span>
                  </div>
                  <div className="mock-list-item">
                    <span>UI THEME</span> 
                    <span className="status">NEURAL NIGHT</span>
                  </div>
                  <div className="mock-list-item">
                    <span>WEB3 PROVIDER</span> 
                    <span className="status">{walletAddress ? 'CONNECTED' : 'DISCONNECTED'}</span>
                  </div>
                </div>
              </div>
            </section>
        ...
        .grid {
            display: grid;
            grid-template-columns: 80px 340px 1fr 340px;
            gap: 24px;
            flex: 1;
            overflow: hidden;
            margin-bottom: 12px;
